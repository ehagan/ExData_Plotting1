...
# Second plot
with(d, plot(DateTime, Voltage, type="l", xlab="datetime", ylab="Voltage", main=""))
...
with(d, legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),lty=c(1,1,1), col=c("black","red","blue"), bty="n"))

with(d, plot(DateTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power", main=""))
